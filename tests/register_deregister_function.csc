...
<simconf>
  ...
  <simulation>
    <title>Test_ukuFlow_engine_01</title>
    ...
    <motetype>
      ...
      <firmware EXPORT="copy">[CONTIKI_DIR]/test/ukuflow/ukuFlow-engine/ukuflow-serial.z1</firmware>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>13.228101500966805</x>
        <y>13.892045295434786</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>0.9090909090909091 0.0 0.0 0.9090909090909091 178.97445318093926 149.37086791324109</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
...
YIELD_THEN_WAIT_UNTIL(msg.contains("Input"));&#xD;
var j = 0;&#xD;
&#xD;
for(j = 0; j &lt; 100; j++){&#xD;
    log.log("round " + j + ", registering workflow\n");&#xD;
    write(mote, "ABqwAwABAQAAAAIBAQICAQEBAAUBYmxpbmsOAQ=="); /* Write to mote serial port */    &#xD;
    var i = 0;&#xD;
    while(true){&#xD;
        YIELD_THEN_WAIT_UNTIL(msg.contains("blink"));&#xD;
        i++;&#xD;
        log.log("blink " + i + ": " +msg+"\n");&#xD;
        if(i==10){&#xD;
            log.log("Deregister workflow");&#xD;
            write(mote, "AbA="); /* deregister */&#xD;
            break;&#xD;
        }    &#xD;
    }&#xD;
    //write(mote, "AbA="); /* deregister */&#xD;
    GENERATE_MSG(2000, "sleep");&#xD;
