...
public class EFProcessingCountFeatureContainer extends EFProcessingFeatureContainer{
	...
	public boolean canApplyTo(Object o) {
		return (o instanceof EFProcessingCount);
	}

	public ICreateFeature getCreateFeature(IFeatureProvider fp) {
		return new EFProcessingCountCreateFeature(fp);
	}

	public IAddFeature getAddFeature(IFeatureProvider fp) {
		return new EFProcessingCountAddFeature(fp);
	}
	...
	public class EFProcessingCountAddFeature extends AbstractAddShapeFeature{
		...
		public boolean canAdd(IAddContext context) {
			...
			if(newObject instanceof EFProcessingCount)
		...
		public PictogramElement add(IAddContext context){
			final EFProcessingCount addedClass = (EFProcessingCount)context.getNewObject(); 
	...
	public class EFProcessingCountDoubleClickFeature extends GenericEditPropertiesFeature{

		public EFProcessingCountDoubleClickFeature(IFeatureProvider fp) {
			super(fp);
		}
