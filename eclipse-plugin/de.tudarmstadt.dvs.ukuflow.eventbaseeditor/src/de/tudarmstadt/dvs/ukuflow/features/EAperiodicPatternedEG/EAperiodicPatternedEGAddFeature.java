...
public class EAperiodicPatternedEGAddFeature extends AbstractAddShapeFeature{

	public EAperiodicPatternedEGAddFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
		...
		if(newObject instanceof eventbase.EPatternedEG)
	...
	public PictogramElement add(IAddContext context) {
		final eventbase.EPatternedEG addedClass = (eventbase.EPatternedEG)context.getNewObject(); 
