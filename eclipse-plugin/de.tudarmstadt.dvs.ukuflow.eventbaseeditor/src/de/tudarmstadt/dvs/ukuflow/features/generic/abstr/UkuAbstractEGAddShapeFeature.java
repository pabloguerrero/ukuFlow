...
public abstract class UkuAbstractEGAddShapeFeature extends
	...
	public UkuAbstractEGAddShapeFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		final EventBaseOperator addedClass = (EventBaseOperator)context.getNewObject();
		...
		int xy[] = new int[] { 0, 0, EG_WIDTH - EG_OFFSET, 0, EG_WIDTH,
				EG_HEIGHT / 2, EG_WIDTH - EG_OFFSET, EG_HEIGHT, 0, EG_HEIGHT, };
		...
		// Shape with ICON
		{
			...
			Image img = service.createImage(ga, EventImageProvider.GEARS_ICON);
