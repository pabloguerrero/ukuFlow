...
public class TutorialAddEReferenceFeature extends AbstractAddFeature {
	...
	public PictogramElement add(IAddContext context) {
		...
		eventbase.ESequenceFlow addedEReference = (eventbase.ESequenceFlow) context.getNewObject();
	...
	public boolean canAdd(IAddContext context) {
		...
		if (context instanceof IAddConnectionContext && context.getNewObject() instanceof eventbase.ESequenceFlow) {
			return true;
		}
		return false;
	}
