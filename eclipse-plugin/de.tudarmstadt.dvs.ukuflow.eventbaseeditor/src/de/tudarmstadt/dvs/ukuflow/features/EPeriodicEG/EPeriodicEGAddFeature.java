...
public class EPeriodicEGAddFeature extends AbstractAddShapeFeature{

	public static final int INVISIBLE_RECT_RIGHT = 6;
	
	public EPeriodicEGAddFeature(IFeatureProvider fp) {
		super(fp);
	}

	public boolean canAdd(IAddContext context) {
		final Object newObject = context.getNewObject();
		if(newObject instanceof eventbase.EPeriodicEG)
	...
	public PictogramElement add(IAddContext context) {
		final eventbase.EPeriodicEG addedClass = (eventbase.EPeriodicEG)context.getNewObject(); 
