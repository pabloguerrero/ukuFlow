...
public class EGPatternedFeatureContainer extends EGFeatureContainer{
	...
	class EGPatternedCreateFeature extends AbstractCreateFeature{
		...
		public Object[] create(ICreateContext context) {
			EGPatterned newClass = EventbaseFactory.eINSTANCE.createEGPatterned();
	...
	public class EGPatternedAddFeature extends AbstractAddShapeFeature{
		...
		public PictogramElement add(IAddContext context) {
			final EGPatterned addedClass = (EGPatterned)context.getNewObject(); 
