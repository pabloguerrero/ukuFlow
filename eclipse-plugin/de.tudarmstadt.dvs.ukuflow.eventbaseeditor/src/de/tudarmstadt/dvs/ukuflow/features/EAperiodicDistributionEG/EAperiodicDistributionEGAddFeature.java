package de.tudarmstadt.dvs.ukuflow.features.EAperiodicDistributionEG;

import org.eclipse.graphiti.examples.tutorial.StyleUtil;
import org.eclipse.graphiti.examples.tutorial.diagram.TutorialFeatureProvider;
...
public class EAperiodicDistributionEGAddFeature extends AbstractAddShapeFeature{

	public EAperiodicDistributionEGAddFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
		...
		if(newObject instanceof eventbase.EDistributionEG)
	...
	public PictogramElement add(IAddContext context) {
		final eventbase.EDistributionEG addedClass = (eventbase.EDistributionEG)context.getNewObject(); 
