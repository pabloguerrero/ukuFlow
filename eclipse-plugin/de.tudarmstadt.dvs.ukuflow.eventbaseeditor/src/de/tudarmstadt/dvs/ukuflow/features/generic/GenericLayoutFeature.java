...
public class GenericLayoutFeature extends AbstractLayoutFeature {

	private static final int MIN_HEIGHT = 30;

	private static final int MIN_WIDTH = 50;

	public GenericLayoutFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canLayout(ILayoutContext context) {
		...
		return businessObjects.size() == 1 && businessObjects.get(0) instanceof EventBaseOperator;
	}
