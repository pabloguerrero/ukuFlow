...
/**
 * use for updating element name
 * @author ”Hien Quoc Dang”
 *
 */
public class GenericUpdateFeature extends AbstractUpdateFeature {

	public GenericUpdateFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canUpdate(IUpdateContext context) {
		...
		return (bo instanceof EventBaseOperator);
	}
