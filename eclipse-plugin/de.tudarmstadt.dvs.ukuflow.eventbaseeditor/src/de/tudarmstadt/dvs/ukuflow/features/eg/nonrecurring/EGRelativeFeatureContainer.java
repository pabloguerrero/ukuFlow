...
public class EGRelativeFeatureContainer extends EGFeatureContainer {
	...
	public class EGRelativeAddFeature extends AbstractAddShapeFeature {
		...
		public PictogramElement add(IAddContext context) {
			final EGRelative addedClass = (EGRelative) context.getNewObject();
			...
			//int xy[] = new int[] { 5, 0, 95, 0, 100, 25, 95, 50, 5, 50, 0,25};
			int xy[] = new int[] { EG_OFFSET,25,0, 0, EG_WIDTH-EG_OFFSET, 0, EG_WIDTH, EG_HEIGHT/2, EG_WIDTH-EG_OFFSET, EG_HEIGHT, 0, EG_HEIGHT, };
			Polygon polygon;
			{
