...
public class TutorialToolBehaviorProvider extends DefaultToolBehaviorProvider {
	...
	public IPaletteCompartmentEntry[] getPalette() {
		...
		*/
		...
		for (ICreateFeature cf : FeatureManager.getEFCreateFeatures(featureProvider)) {
			...
			ef.addCreationToolEntry(objectCreationToolEntry);
		}		
		for (ICreateFeature cf : FeatureManager.getEGCreateFeatures(featureProvider)) {
			ObjectCreationToolEntry objectCreationToolEntry = 
					new ObjectCreationToolEntry(cf.getCreateName(), cf.getCreateDescription(),
					cf.getCreateImageId(), cf.getCreateLargeImageId(), cf);
			eventGeneratorEntry.addToolEntry(objectCreationToolEntry);
			eg.addCreationToolEntry(objectCreationToolEntry);
		}
