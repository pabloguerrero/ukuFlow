 ...
 * <ul>
 *   <li>{@link eventbase.EGAbsolute#getAbsoluteTime <em>Absolute Time</em>}</li>
 * </ul>
 * </p>
 *
 * @see eventbase.EventbasePackage#getEGAbsolute()
 * @model
 * @generated
 */
public interface EGAbsolute extends EGNonRecurring {
	 ...
	 * @see eventbase.EventbasePackage#getEGAbsolute_AbsoluteTime()
	 * @model required="true"
	 * @generated
	 */
	int getAbsoluteTime();
	...
	/**
	 * Sets the value of the '{@link eventbase.EGAbsolute#getAbsoluteTime <em>Absolute Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
