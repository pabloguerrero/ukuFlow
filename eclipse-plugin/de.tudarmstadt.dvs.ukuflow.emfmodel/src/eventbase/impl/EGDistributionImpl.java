 ...
 * <ul>
 *   <li>{@link eventbase.impl.EGDistributionImpl#getTime <em>Time</em>}</li>
 *   <li>{@link eventbase.impl.EGDistributionImpl#getFunction <em>Function</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EGDistributionImpl extends EGRecurringImpl implements EGDistribution {
	 ...
	 * @ordered
	 */
	protected static final int FUNCTION_EDEFAULT = 0;
	 ...
	 * @ordered
	 */
	protected int function = FUNCTION_EDEFAULT;
	...
	public void setTime(int newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventbasePackage.EG_DISTRIBUTION__TIME, oldTime, time));
	}
