 ...
 * <ul>
 *   <li>{@link eventbase.EGRelative#getDelayTime <em>Delay Time</em>}</li>
 * </ul>
 * </p>
 *
 * @see eventbase.EventbasePackage#getEGRelative()
 * @model
 * @generated
 */
public interface EGRelative extends EGNonRecurring {
	 ...
	 * @see eventbase.EventbasePackage#getEGRelative_DelayTime()
	 * @model required="true"
	 * @generated
	 */
	int getDelayTime();
	...
	/**
	 * Sets the value of the '{@link eventbase.EGRelative#getDelayTime <em>Delay Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
