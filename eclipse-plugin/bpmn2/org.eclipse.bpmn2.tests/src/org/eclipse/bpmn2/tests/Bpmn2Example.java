...
public class Bpmn2Example {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            ...
            try {
                Resource resource = resourceSet.createResource(URI.createURI("http:///My.bpmn2"));
                DocumentRoot documentRoot = Bpmn2Factory.eINSTANCE.createDocumentRoot();
                Activity root = Bpmn2Factory.eINSTANCE.createActivity();
                documentRoot.setActivity(root);
