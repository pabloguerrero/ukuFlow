 ...
 *   <li>{@link org.eclipse.bpmn2.impl.ProcessImpl#getMindotInstances <em>Mindot Instances</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.impl.ProcessImpl#getMaxdotInstances <em>Maxdot Instances</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.impl.ProcessImpl#getNumber_ofLoops <em>Number of Loops</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessImpl extends CallableElementImpl implements org.eclipse.bpmn2.Process {
    ...
    /**
     * The default value of the '{@link #getMindotInstances() <em>Mindot Instances</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getMindotInstances()
     * @generated
     * @ordered
     */
    protected static final int MINDOT_INSTANCES_EDEFAULT = 1;

    /**
     * The cached value of the '{@link #getMindotInstances() <em>Mindot Instances</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getMindotInstances()
     * @generated
     * @ordered
     */
    protected int mindotInstances = MINDOT_INSTANCES_EDEFAULT;

    /**
     * The default value of the '{@link #getMaxdotInstances() <em>Maxdot Instances</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getMaxdotInstances()
     * @generated
     * @ordered
     */
    protected static final int MAXDOT_INSTANCES_EDEFAULT = 1;

    /**
     * The cached value of the '{@link #getMaxdotInstances() <em>Maxdot Instances</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getMaxdotInstances()
     * @generated
     * @ordered
     */
    protected int maxdotInstances = MAXDOT_INSTANCES_EDEFAULT;

    /**
     * The default value of the '{@link #getNumber_ofLoops() <em>Number of Loops</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getNumber_ofLoops()
     * @generated
     * @ordered
     */
    protected static final int NUMBER_OF_LOOPS_EDEFAULT = 0;

    /**
     * The cached value of the '{@link #getNumber_ofLoops() <em>Number of Loops</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getNumber_ofLoops()
     * @generated
     * @ordered
     */
    protected int number_ofLoops = NUMBER_OF_LOOPS_EDEFAULT;
     ...
     * @generated
     */
    public int getMindotInstances() {
        return mindotInstances;
    }
     ...
     * @generated
     */
    public void setMindotInstances(int newMindotInstances) {
        int oldMindotInstances = mindotInstances;
        mindotInstances = newMindotInstances;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.PROCESS__MINDOT_INSTANCES, oldMindotInstances, mindotInstances));
    }
     ...
     * @generated
     */
    public int getMaxdotInstances() {
        return maxdotInstances;
    }
     ...
     * @generated
     */
    public void setMaxdotInstances(int newMaxdotInstances) {
        int oldMaxdotInstances = maxdotInstances;
        maxdotInstances = newMaxdotInstances;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.PROCESS__MAXDOT_INSTANCES, oldMaxdotInstances, maxdotInstances));
    }
     ...
     * @generated
     */
    public int getNumber_ofLoops() {
        return number_ofLoops;
    }
     ...
     * @generated
     */
    public void setNumber_ofLoops(int newNumber_ofLoops) {
        int oldNumber_ofLoops = number_ofLoops;
        number_ofLoops = newNumber_ofLoops;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.PROCESS__NUMBER_OF_LOOPS, oldNumber_ofLoops, number_ofLoops));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case Bpmn2Package.PROCESS__MINDOT_INSTANCES:
            return getMindotInstances();
        case Bpmn2Package.PROCESS__MAXDOT_INSTANCES:
            return getMaxdotInstances();
        case Bpmn2Package.PROCESS__NUMBER_OF_LOOPS:
            return getNumber_ofLoops();
        }
    ...
    public void eSet(int featureID, Object newValue) {
        ...
        case Bpmn2Package.PROCESS__PROCESS_TYPE:
            ...
            return;
        case Bpmn2Package.PROCESS__MINDOT_INSTANCES:
            setMindotInstances((Integer) newValue);
            return;
        case Bpmn2Package.PROCESS__MAXDOT_INSTANCES:
            setMaxdotInstances((Integer) newValue);
            return;
        case Bpmn2Package.PROCESS__NUMBER_OF_LOOPS:
            setNumber_ofLoops((Integer) newValue);
            return;
        }
    ...
    public void eUnset(int featureID) {
        ...
        case Bpmn2Package.PROCESS__PROCESS_TYPE:
            ...
            return;
        case Bpmn2Package.PROCESS__MINDOT_INSTANCES:
            setMindotInstances(MINDOT_INSTANCES_EDEFAULT);
            return;
        case Bpmn2Package.PROCESS__MAXDOT_INSTANCES:
            setMaxdotInstances(MAXDOT_INSTANCES_EDEFAULT);
            return;
        case Bpmn2Package.PROCESS__NUMBER_OF_LOOPS:
            setNumber_ofLoops(NUMBER_OF_LOOPS_EDEFAULT);
            return;
        }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case Bpmn2Package.PROCESS__MINDOT_INSTANCES:
            return mindotInstances != MINDOT_INSTANCES_EDEFAULT;
        case Bpmn2Package.PROCESS__MAXDOT_INSTANCES:
            return maxdotInstances != MAXDOT_INSTANCES_EDEFAULT;
        case Bpmn2Package.PROCESS__NUMBER_OF_LOOPS:
            return number_ofLoops != NUMBER_OF_LOOPS_EDEFAULT;
        }
    ...
    public String toString() {
        ...
        result.append(processType);
        result.append(", mindotInstances: ");
        result.append(mindotInstances);
        result.append(", maxdotInstances: ");
        result.append(maxdotInstances);
        result.append(", number_ofLoops: ");
        result.append(number_ofLoops);
        result.append(')');
