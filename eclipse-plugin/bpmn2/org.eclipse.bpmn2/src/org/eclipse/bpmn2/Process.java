 ...
 *   <li>{@link org.eclipse.bpmn2.Process#getMindotInstances <em>Mindot Instances</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.Process#getMaxdotInstances <em>Maxdot Instances</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.Process#getNumber_ofLoops <em>Number of Loops</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Process extends CallableElement, FlowElementsContainer {
    ...
    /**
     * Returns the value of the '<em><b>Mindot Instances</b></em>' attribute.
     * The default value is <code>"1"</code>.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Mindot Instances</em>' attribute isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * @return the value of the '<em>Mindot Instances</em>' attribute.
     * @see #setMindotInstances(int)
     * @see org.eclipse.bpmn2.Bpmn2Package#getProcess_MindotInstances()
     * @model default="1"
     * @generated
     */
    int getMindotInstances();

    /**
     * Sets the value of the '{@link org.eclipse.bpmn2.Process#getMindotInstances <em>Mindot Instances</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param value the new value of the '<em>Mindot Instances</em>' attribute.
     * @see #getMindotInstances()
     * @generated
     */
    void setMindotInstances(int value);

    /**
     * Returns the value of the '<em><b>Maxdot Instances</b></em>' attribute.
     * The default value is <code>"1"</code>.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Maxdot Instances</em>' attribute isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * @return the value of the '<em>Maxdot Instances</em>' attribute.
     * @see #setMaxdotInstances(int)
     * @see org.eclipse.bpmn2.Bpmn2Package#getProcess_MaxdotInstances()
     * @model default="1"
     * @generated
     */
    int getMaxdotInstances();

    /**
     * Sets the value of the '{@link org.eclipse.bpmn2.Process#getMaxdotInstances <em>Maxdot Instances</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param value the new value of the '<em>Maxdot Instances</em>' attribute.
     * @see #getMaxdotInstances()
     * @generated
     */
    void setMaxdotInstances(int value);

    /**
     * Returns the value of the '<em><b>Number of Loops</b></em>' attribute.
     * The default value is <code>"0"</code>.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Number of Loops</em>' attribute isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * @return the value of the '<em>Number of Loops</em>' attribute.
     * @see #setNumber_ofLoops(int)
     * @see org.eclipse.bpmn2.Bpmn2Package#getProcess_Number_ofLoops()
     * @model default="0"
     * @generated
     */
    int getNumber_ofLoops();

    /**
     * Sets the value of the '{@link org.eclipse.bpmn2.Process#getNumber_ofLoops <em>Number of Loops</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param value the new value of the '<em>Number of Loops</em>' attribute.
     * @see #getNumber_ofLoops()
     * @generated
     */
    void setNumber_ofLoops(int value);
